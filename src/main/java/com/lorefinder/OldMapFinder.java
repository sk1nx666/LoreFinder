...
public class OldMapFinder extends Module {
    ...
    private final Setting<Boolean> tracers = sgRender.add(new BoolSetting.Builder()
        .name("tracers")
        .description("Draw tracers to old maps.")
        .defaultValue(false)
        .build()
    );
    ...
    public OldMapFinder() {
        super(LoreFinderAddon.CATEGORY, "old-map-finder", "ESP for filled maps with a low map ID in render distance.");
    }
